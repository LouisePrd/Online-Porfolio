...
export const projectsData: Record<string, Project> = {
  ...
  "piageon": {
    ...
    "girlyChaos": {
    title: "Girly Chaos",
    intro: "Somewhere between image synthesis and OpenGL: when the classic game of chess meets mathematical randomness.",
    type: "Software / Game",
    date: "2025",
    context: "Two student projects at IMAC, combining C++, OpenGL, and mathematics",
    technos: "C#, OpenGL, GLSL",
    description: "The project was a combination of three courses from the semester: C++, OpenGL, and mathematics. The goal? To reimplement a 3D chess game while applying mathematical probability theory. For example, we created “Crazy Bishop” (Poisson Distribution), in which the bishop's movement paths are subject to random deviations generated by a Poisson process with a controlled frequency.",
    styleClass: "girlyChaos",
    githubUrl: "https://github.com/LouisePrd/Grily-Chaos",
    reportUrl: "https://canva.link/lluuu136x1fdnfh",
    images: [
      "/imgs/projects/girlyChaos/render1.webp",
      "/imgs/projects/girlyChaos/render2.webp",
      "/imgs/projects/girlyChaos/render3.webp",
      "/imgs/projects/girlyChaos/render4.webp",
    ]
  },
  "auFilDuTemps": {
