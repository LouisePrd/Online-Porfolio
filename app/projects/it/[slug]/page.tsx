    ...
    <main className={`${styles.projectPage} ${styles[project.styleClass]}`}>
      ...
      <div className={styles.projectContainer}>
        <div className={styles.presentation}>
          <p><span className={styles.bold}>Project type :</span> {project.type}</p>
          <p><span className={styles.bold}>Date :</span> {project.date}</p>
          <p><span className={styles.bold}>Context :</span> {project.context}</p>
          <p><span className={styles.bold}>Technologies :</span> {project.technos}</p>
        </div>
      ...
      <div className={styles.btnLinks}>
        ...
        {project.companyUrl && (
          <a href={project.companyUrl} target="_blank" rel="noopener noreferrer" className={styles.linkedinBtn}>
            View company
          </a>
        )}
      </div>
